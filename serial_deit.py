...
# torchrun   --nnodes=4   --nproc-per-node=1   --node-rank=0   --master-addr=192.168.1.118   --master-port=50000   lab6_chl/serial_deit.py
# python  lab6_chl/serial_deit.py   --nnodes=4   --nproc-per-node=1   --node-rank=0   --master-addr=192.168.1.118   --master-port=50000
